""" Editing Guide
    ...
    The code declares a text string. You need to take two string inputs, which
    represent the substring to find and what to replace it with in the text.
...
original = input("Input the word to be replaced: ")
replacement = input("Input the new word: ")

print(text.count(original))
print(text.replace(original, replacement))
